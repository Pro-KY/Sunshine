...
public class NotificationUtils {
    ...
    // store the indices of the values in the array of Strings above to more quickly be able
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            //NotificationCompat.Builder to begin building the notification
            ...
            // Intent with the proper URI to start the DetailActivity
            Intent  detailIntentForToday = new Intent(context, DetailActivity.class);
            detailIntentForToday.setData(todaysWeatherUri);

            // navigate back to the MainActivity from the DetailActivity if the user
            // clicks the Notification and then clicks back
